...
set CLASSPATH=%APP_HOME%\lib\project-1.0-SNAPSHOT.jar;%APP_HOME%\lib\lanterna-3.0.2.jar

@rem Execute project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" g24.Application %CMD_LINE_ARGS%
