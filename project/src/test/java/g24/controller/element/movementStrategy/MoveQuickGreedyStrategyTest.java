...
public class MoveQuickGreedyStrategyTest {
    @Test
    public void move(){
        ...
        MoveQuickGreedyStrategy greedyMoveStrategy = new MoveQuickGreedyStrategy(isaac);

        //The first FPS/3 Times should be the same
        for (int i = 0; i < GameConfig.FPS/12-1; i++) {
